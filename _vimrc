...
elseif MySys() == "linux"
	let Tlist_Ctags_Cmd = '/usr/local/bin/ctags' "Éè¶¨linuxÏµÍ³ÖĞctags³ÌĞòµÄÎ»ÖÃ
endif
...
elseif MySys() == 'windows'
	...
	nmap <silent> <leader>ee :call SwitchToBuf("$VIM/_gvimrc")<cr>
...
nmap <silent> <leader>mp :call CechohangeMakeprg()<cr>
